...
WebGLLoop = function() {
    ...
    mainCanvasGL.clearColor(215/255.0, 214/255.0, 213/255.0, 1.0)
    ...
    //glMatrix.mat4.ortho(perspectiveProjection, -width/40, width/40, -height/40, height/40, 0.01, 2000.0);
    glMatrix.mat4.perspective(perspectiveProjection, glMatrix.glMatrix.toRadian(90), (width/height), 0.1, 2000.0);
    ...
    UniformVector3Location(mainShader, "col", [215, 214, 213], mainCanvasGL)
    //mainCanvasGL.drawElements(mainCanvasGL.TRIANGLES, terrain.indices.length, mainCanvasGL.UNSIGNED_SHORT, 0)

    UniformVector3Location(mainShader, "col", [67, 65, 63], mainCanvasGL);
